...
var jUri ='/kumbia/default/public/'
...
Modernizr.load({
  ...
  nope: jUri + 'plugins/forms/placeholder/jquery.placeholder.min.js',
  complete: function () {
...
Modernizr.load({
  ...
  yep: [jUri +'plugins/fix/ios-fix/ios-orientationchange-fix.js', jUri +'plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	if(supr_Options.rtl) {
		...
		$('#bootstrap').attr('href', jUri +'css/bootstrap/bootstrap.rtl.min.css');
		$('#bootstrap-responsive').attr('href', jUri +'css/bootstrap/bootstrap-responsive.rtl.min.css');
		$('body').addClass('rtl');
